...
class Final(object):
    def __init__(self):
        ...
        self.yolo_model = torch.hub.load('/home/tongshen/.local/lib/python3.8/site-packages/yolov5', 'custom', path='/home/tongshen/Projects/AuE8230Spring23_Tongshen/catkin_ws/src/auefinals/src/yolov5s.pt', source='local')
